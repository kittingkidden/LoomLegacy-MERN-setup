                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-stone-400 text-sm leading-relaxed">
                            Weaving traditions, empower artisans. Supporting the hands that create timeless beauty through authentic handloom craftsmanship.
                        </p>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2 text-sm text-olive-200">
                            <li><Link to="/shop" className="hover:text-terracotta-300 transition-colors">Sarees</Link></li>
                            <li><Link to="/shop" className="hover:text-terracotta-300 transition-colors">Shawls</Link></li>
                            <li><Link to="/shop" className="hover:text-terracotta-300 transition-colors">Home Decor</Link></li>
                            <li><Link to="/shop" className="hover:text-terracotta-300 transition-colors">New Arrivals</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2 text-sm text-olive-200">
                            <li><Link to={localStorage.getItem('user') ? "/dashboard" : "/login"} className="hover:text-terracotta-300 transition-colors">Track Order</Link></li>
                            <li><Link to="/our-story" className="hover:text-terracotta-300 transition-colors">Shipping Policy</Link></li>
                            <li><Link to="/our-story" className="hover:text-terracotta-300 transition-colors">Returns & Refunds</Link></li>
                            <li><Link to="/our-story" className="hover:text-terracotta-300 transition-colors">Contact Us</Link></li>
                        </ul>
                    </div>
