        ...
        <Link to="/" className={`flex items-center gap-2 group ${className}`}>
            ...
            <div className="flex flex-col">
                <span className="font-display font-bold text-2xl leading-none tracking-tight text-stone-800 group-hover:text-olive-700 transition-colors flex items-center">
                    L<span className="text-3xl -mt-1 mx-px bg-linear-to-r from-olive-700 via-olive-500 to-lime-500 bg-clip-text text-transparent inline-block filter drop-shadow-sm">∞</span>m<span className="text-olive-600">Legacy</span>
                </span>
