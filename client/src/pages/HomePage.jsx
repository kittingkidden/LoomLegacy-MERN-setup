...
const Marquee = () => {
    return (
        <div className="relative flex overflow-x-hidden bg-terracotta-600/90 backdrop-blur-sm py-3 border-y border-terracotta-500/30 mt-12 mb-8">
            <motion.div
...
const HomePage = () => {
    ...
    return (
        <div className="min-h-screen bg-cream-50 bg-noise relative overflow-x-hidden selection:bg-terracotta-200">
            ...
            <section className="relative min-h-[92vh] flex flex-col pt-24 pb-20 px-4 md:px-8 max-w-[1600px] mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 grow items-center">
                    ...
                    <div className="lg:col-span-5 flex flex-col justify-center relative z-10">
                        <motion.div initial="hidden" animate="visible" variants={staggerText} className="mb-8">
                            ...
                            <div className="overflow-hidden">
                                <motion.h1 className="font-sans font-black text-5xl md:text-7xl lg:text-8xl leading-none text-transparent bg-clip-text bg-linear-to-r from-terracotta-600 to-orange-500 uppercase tracking-tight">
                                    <motion.span variants={letterAnim}>Empower-</motion.span><br />
                                    <motion.span variants={letterAnim}>ing Lives.</motion.span>
                                </motion.h1>
                            </div>
                        </motion.div>
                ...
                <motion.div
                    ...
                    className="absolute bottom-20 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-stone-400 z-20 pointer-events-none"
                >
            ...
            <section className="py-24 px-4 max-w-6xl mx-auto">
                <div className="flex flex-col md:flex-row gap-12 items-center bg-white rounded-5xl p-8 md:p-12 shadow-xl border border-stone-100 relative overflow-hidden">
                    ...
                    <div className="md:w-1/2 relative">
                        <div className="relative rounded-4xl overflow-hidden aspect-4/5 group">
                        ...
                        {reviews.length > 0 ? reviews.map((review, idx) => (
                            ...
                            >
                                <div className="flex items-start gap-4 mb-6">
                                    <div className="w-12 h-12 bg-terracotta-600 rounded-full flex items-center justify-center text-white font-bold text-lg">
                                        {review.user?.name?.charAt(0) || "U"}
                                    </div>
                                    <div>
                                        <p className="font-bold text-white text-lg">{review.user?.name || "Verified Customer"}</p>
                            ...
                            <p className="text-stone-500 font-serif italic text-lg col-span-2 text-center">"Stories from our community will appear here soon."</p>
                        )}
                    </div>
                </div>
            </section>
