                ...
                <div className="w-full md:w-1/2 space-y-8">
                    <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }}>
                        ...
                        <div className="flex items-center gap-4 text-sm text-stone-500 border-b border-stone-100 pb-6">
                            ...
                            <span>Crafted by <Link to="/shop" className="font-bold text-terracotta-700 underline decoration-terracotta-200 hover:decoration-terracotta-600 transition-all">{product.artisan}</Link></span>
                        </div>
                    </motion.div>
