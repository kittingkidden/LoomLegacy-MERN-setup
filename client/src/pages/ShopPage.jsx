...
const ShopPage = () => {
    ...
    // Derived states
    const collectionStories = categoriesData.reduce((acc, cat) => {
                        ...
                        {filteredProducts.length > 0 ? (
                            ...
                            >
                                ...
                                <div className="relative z-10 max-w-md mx-auto px-4">
                                    ...
                                    <Link to="/our-story" className="inline-block text-stone-900 font-bold border-b-2 border-terracotta-400 hover:text-terracotta-600 transition-colors uppercase tracking-widest text-xs py-1">
