                ...
                <div className="lg:col-span-2">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <input required name="address" value={formData.address} onChange={handleInputChange} type="text" className="w-full px-3 py-2 border border-stone-200 rounded-md focus:border-terracotta-500 focus:outline-none" />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium text-stone-700 mb-1">City</label>
                                        <input required name="city" value={formData.city} onChange={handleInputChange} type="text" className="w-full px-3 py-2 border border-stone-200 rounded-md focus:border-terracotta-500 focus:outline-none" />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium text-stone-700 mb-1">Pincode</label>
                                        <input required name="pincode" value={formData.pincode} onChange={handleInputChange} type="text" className="w-full px-3 py-2 border border-stone-200 rounded-md focus:border-terracotta-500 focus:outline-none" />
                                    </div>
                                </div>
                    ...
                    {step === 2 && (
                        <div className="bg-white p-6 rounded-lg shadow-sm border border-stone-100">
                            ...
                            <button onClick={handlePayment} disabled={isProcessing} className="mt-8 w-full bg-terracotta-600 text-white py-3 rounded-md font-medium hover:bg-terracotta-700 transition-colors disabled:opacity-50">
